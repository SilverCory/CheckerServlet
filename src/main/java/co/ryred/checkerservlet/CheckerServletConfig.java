...
public class CheckerServletConfig
{
	...
	public static void init( boolean force )
	{
		...
		for ( Field field : CheckerServletConfig.class.getDeclaredFields() ) {
	...
	private static void dataSettings()
	{
		...
		if ( !configFile.exists() ) {
			try {
				...
				IOUtils.copy( CheckerServlet.class.getResourceAsStream( "/spring.xml" ), new FileOutputStream( configFile ) );
